    ...
    class ELangPick extends CPortlet
    {
        ...
        */
        protected function renderContent()
        {
            ...
            echo '<div id="languagePickerContainer" style="text-align:right;">';
            switch ($this->pickerType)
            {
                ...
                case 'dropdown':
                    ...
                    echo CHtml::form('', 'post', array('style'=>$this->formStyle));
                    echo CHtml::dropDownList('languagePicker' , Yii::app()->getLanguage(), $translationsU, array('submit'=>'', 'csrf'=>true),array('style'=>'float:right;'));
                    echo CHtml::endForm();
                    break;
                case 'links':
                    foreach ($translations as $trans)
