...
// 		Yii::t('strings','Manager')=>array("/manager"),
	...
	$model->title=>array('individualPageView','id'=>$model->id),
	Yii::t('strings','Update'),
);

	$this->menu=array(
			array('label'=>Yii::t('strings','Create Individual Page'), 'url'=>array('individualPagecreate')),
			array('label'=>Yii::t('strings','View Individual Page'), 'url'=>array('individualPageview', 'id'=>$model->id)),
...
<center><h3><?php echo Yii::t('strings','Update Individual Page').' #'; echo $model->id; ?></h3></center>
