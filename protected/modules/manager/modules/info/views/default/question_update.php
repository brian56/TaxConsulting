...
$this->menu = array (
		array (
				'label' => Yii::t ( 'strings', 'Create Question' ),
				'url' => array (
						'questioncreate' 
				) 
		),
		array (
				'label' => Yii::t ( 'strings', 'View Question' ),
				'url' => array (
						'questionview',
						'id' => $model->id 
				) 
		...
		array (
				'label' => Yii::t ( 'strings', 'Delete Question' ),
				'url' => '#',
				'linkOptions' => array (
						'submit' => array (
								'delete',
...
<center>
	<h3><?php echo Yii::t('strings','Update Question').' #'; echo $model->id; ?></h3>
</center>
