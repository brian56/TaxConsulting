...
// 					),
					array (
							...
							'url' => array (
									'/manager/info/default/individualPage' 
							),
							'visible' => (! Yii::app ()->user->isGuest && Yii::app ()->user->getState ( "isManager" )),
...
$this->widget ( 'zii.widgets.CBreadcrumbs', array (
	...
	<div class="clear"></div>
		...
		<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by <a
				href="http://www.appromobile.com/" rel="external">Appromobile</a>.<br />
